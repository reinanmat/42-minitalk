...
/*   Updated: 2023/01/07 13:06:54 by revieira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (!ft_str_is(argv[2], ft_isascii))
		ft_exit_program("Error: message contains non ascii characters", 1);
